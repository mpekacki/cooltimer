...
test('displays values passed in props', () => {
  const { getByDisplayValue } = render(<UserSettings workMinutes={ 13 } shortBreakMinutes={ 3 } longBreakMinutes = { 7 } longBreakFreq={ 2 } />);
...
test('calls callback after changing value 1', () => {
  ...
  const { getByDisplayValue } = render(<UserSettings workMinutes={ 13 } shortBreakMinutes={ 3 } longBreakMinutes = { 7 } longBreakFreq={ 2 } onchange={callback} />);
